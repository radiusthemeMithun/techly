...
class ProjectRelated {
	public static function rt_project_related() {
		...
		$title_length = techly_option( 'rt_project_related_title_limit' ) ? techly_option( 'rt_project_related_title_limit' ) : '';
		$related_item_number = techly_option( 'rt_project_related_limit' );
		...
		$query_type = techly_option( 'rt_project_related_query' );
		...
		if( techly_option( 'rt_project_related_sort' ) ){

			$post_order = techly_option( 'rt_project_related_sort' );
		...
		if( $related_query->have_posts() && techly_option( 'rt_project_related' ) ) { ?>
			<div class="rt-project-default rt-project-multi-layout-default rt-related-project">
				<div class="container">
					<h2 class="related-title"><?php techly_html( techly_option( 'rt_project_related_title' ) , 'allow_title' );?></h2>
					<div class="row g-4">
