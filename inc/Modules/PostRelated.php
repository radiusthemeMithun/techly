...
class PostRelated {
	...
	public static function rt_post_related() {
		...
		$related_item_number = techly_option( 'rt_post_related_limit' );

		# Making ready to the Query ...
		$query_type = techly_option( 'rt_post_related_query' );
		...
		if( techly_option( 'rt_post_related_sort' ) ){

			$post_order = techly_option( 'rt_post_related_sort' );
		...
		if( $related_query->have_posts() && techly_option( 'rt_post_related' ) ) { ?>
			<div class="blog-default rt-related-post">
				<div class="container">
					<h2 class="related-title"><?php techly_html( techly_option( 'rt_post_related_title' ) , 'allow_title' );?></h2>
					<div class="row">
						<?php while ( $related_query->have_posts() ) {
						$related_query->the_post();
							$meta_list = techly_option( 'rt_blog_meta', '', true );
							if ( techly_option( 'rt_blog_above_meta_visibility' ) ) {
						...
						<div class="col-sm-6 col-xl-4 col-lg-4" >
							<article data-post-id="<?php the_ID(); ?>" <?php post_class( techly_post_class() ); ?>>
								<div class="article-inner-wrapper">
									...
									<?php techly_post_thumbnail('techly-size3'); ?>
									...
									<div class="entry-wrapper">
										<header class="entry-related-header">
											...
											techly_separate_meta( 'title-above-meta' );
