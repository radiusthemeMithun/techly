	...
	<div class="single-post-pagination <?php echo esc_attr( $cols ) ?>">
		<?php if ( $previous ):
			...
			<div class="post-navigation prev">
				...
				<?php echo techly_get_svg( 'arrow-right', '180' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		...
		<?php if ( $next ):
			...
			<div class="post-navigation next text-right">
				...
				<?php echo techly_get_svg( 'arrow-right' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			</div>
		<?php endif; ?>
	</div>
<?php } ?>
